...
class Model_Finder:
    ...
    def get_best_params_for_naive_bayes(self,train_x,train_y):
        ...
        try:
            ...
            self.param_grid = {"var_smoothing": [1e-9,0,0.1, 0.001, 0.5,0.05,0.01,1e-8,1e-7,1e-6,1e-10,1e-11]}

            #Creating an object of the Grid Search class
            self.grid = GridSearchCV(estimator=self.gnb, param_grid=self.param_grid, cv=5,  verbose=3,refit=False)
    ...
    def get_best_params_for_xgboost(self,train_x,train_y):
        ...
        try:
            ...
            # finding the best parameters
            self.logger_object.log(self.file_object,
                                   'Unique values of y:'+str(train_y.unique()))
            self.grid.fit(train_x, train_y)
