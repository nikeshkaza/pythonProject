...
class trainModel:
    ...
    def __init__(self):
        ...
        self.file_object = open("/Users/nikeshkaza/PycharmProjects/pythonProject/IncomePrediction_copy/Training_Logs/ModelTrainingLog.txt", 'a+')
    def trainingModel(self):
        ...
        try:
            ...
            X.to_excel('/Users/nikeshkaza/PycharmProjects/pythonProject/IncomePrediction_copy/data/export.xlsx')
            ...
            for i in list_of_clusters:
                ...
                # logging the training phase for respective cluster
                self.log_writer.log(self.file_object, 'Entered Training for CLuster:'+str(i))
                # Prepare the feature and Label columns
                cluster_features=cluster_data.drop(['Labels','Cluster'],axis=1)
                cluster_label= cluster_data['Labels']

                # splitting the data into training and test set for each cluster one by one
                x_train, x_test, y_train, y_test = train_test_split(cluster_features, cluster_label, test_size=0.33, random_state=1)
