...
from IncomePrediction_copy.file_operations import file_methods
...
class KMeansClustering:
    ...
    def elbow_plot(self,data):
        ...
        try:
            for i in range (1,11):
                kmeans=KMeans(n_clusters=i,init='k-means++',random_state=1) # initializing the KMeans object
    ...
    def create_clusters(self,data,number_of_clusters):
        ...
        self.data=data
        try:
            self.kmeans = KMeans(n_clusters=number_of_clusters, init='k-means++', random_state=1)
