    ...
    def is_null_present(self,data):
        ...
        try:
            ...
            if(self.null_present): # write the logs to see which columns have null values
                ...
                self.dataframe_with_null.to_csv('/Users/nikeshkaza/PycharmProjects/pythonProject/IncomePrediction_copy/preprocessing_data/null_values.csv') # storing the null column information to file
